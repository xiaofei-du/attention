...
(
  ...
  /usr/bin/curl -qfsSL --proto '=https' --proto-redir '=https' --max-time 30 --max-filesize 1048576 \
    ...
    https://api.github.com/repos/xiaofei-du/attention/git/blobs/1a4b0d84587fadef80c4c07420575aa1c7aa4e25 -o "$entry"
  digest="$(/usr/bin/env -u PERL5OPT -u PERL5LIB /usr/bin/shasum -a 256 "$entry")"
  [ "${digest%% *}" = '259fb490a1fb5efda9c22473c4cbfc03adae3bfd2c75034ce7e1e8a6eb23e275' ] || {
